...
}),n.on("chat message",function(t){$("#messages").append($("<li>").text(t.username+": "+t.msg).addClass("animated fadeInUp message ")),e()}),n.on("show newUser",function(t){var n=$("<li>").text(t.username+" is online").addClass("text-center new-user animated fadeInUp");n.prepend($("<i>").addClass("fa fa-user-plus")),$("#messages").append(n),e()}),n.on("user offline",function(t){var n=$("<li>").text(t.username+" left the chat").addClass("text-center user-offline animated fadeInUp");n.prepend($("<i>").addClass("fa fa-user-times")),$("#messages").append(n),e()}),n.on("users counter",function(e){$("#usersCount").html("Online: <strong>"+e.usersCount+"</strong> Users")})});